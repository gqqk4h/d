...
local function lsp_keymaps(bufnr)
  ...
  keymap(
    ...
    "n",
    "<C-j>",
    "<cmd>lua vim.diagnostic.goto_next({buffer=0,float=false})<cr>", -- turn floating off, instead show lsp_lines
    opts
  )
  keymap(
    bufnr,
    "n",
    "<C-k>",
    "<cmd>lua vim.diagnostic.goto_prev({buffer=0,float=false})<cr>", -- turn floating off, instead show lsp_lines
    opts
  )
